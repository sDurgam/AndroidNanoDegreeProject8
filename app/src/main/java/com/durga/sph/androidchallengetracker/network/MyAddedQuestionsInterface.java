...
public class MyAddedQuestionsInterface extends FirebaseDatabaseInterface {

    public void getQuestions(final String key, final String user, final IGetQuestionsInterface callback) {
